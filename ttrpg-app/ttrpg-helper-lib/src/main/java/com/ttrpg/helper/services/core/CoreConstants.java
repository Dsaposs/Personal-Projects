...
public class CoreConstants {
    ...
    public static final String CHARACTERS_FOR_USER_URI = "/add/";
    ...
    public static final String GAMES_BY_USER_URI = "/" + USER_ID;
    public static final String GAME_BY_GAME_ID_URI = "/" + GAME_ID;
}
